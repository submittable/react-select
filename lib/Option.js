	...
	_createClass(Option, [{
		...
		value: function render() {
			...
			return option.disabled ? _react2.default.createElement(
				...
				'div',
				(_React$createElement = { className: className,
					style: option.style,
					role: 'option',
				...
				}, _defineProperty(_React$createElement, 'aria-label', this.props.children), _defineProperty(_React$createElement, 'title', option.title), _React$createElement),
				this.props.children
			);
		}
	}]);
